...
public class utility {
	...
	public static String readDataFromExcel(String excelPath, String sheetName, int
	rowNum, int cellNum)
	...
	FileInputStream myFile = new FileInputStream(System.getProperty("user.dir") +"//config.properties1");
